...
3. **Generate message** using the 3-sentence framework:
   ...
   - **Sentence 2 (Proof)**: Candidate's most quantifiable relevant achievement for THAT role (e.g., "I built an AI agent handling 90% of customer service at my company before selling it")
