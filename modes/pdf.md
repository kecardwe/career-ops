...
13. Write HTML to `output/cv-{company}-{YYYY-MM-DD}.html`
14. Run: `node generate-pdf.mjs output/cv-{company}-{YYYY-MM-DD}.html output/cv-{company}-{YYYY-MM-DD}.pdf --format={letter|a4}`
