...
1. **Extract form questions**: Use Playwright to navigate the form and take a snapshot. If not possible, use the generic questions below.
...
- **Selective without being dismissive**: "I've been intentional about finding a team where I can contribute meaningfully from day one"
